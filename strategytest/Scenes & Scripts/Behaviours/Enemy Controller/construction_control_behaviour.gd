...
var wall_rotations = [Vector3(0.0, -99.6, 0.0), Vector3(0.0, -136.9, 0.0), Vector3(0.0, 154.3, 0.0)] # the rotations for constructed walls
...
func constructNext():
	...
	match construct:
		...
		3:
			...
			building.rotation = wall_rotations[0] # also sets the wall's rotation
