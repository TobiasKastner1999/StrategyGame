...
var construction_locations = [[0, [Vector3(-105.0, -3.2, 105.0), Vector3(-90.0, -3.2, 145.0), Vector3(-60.0, -3.2, 115.0)], [Vector3(-130.0, -4.2, 140.0), Vector3(-140.0, -4.2, 100.0), Vector3(-50.0, -4.2, 140.0)], 3], \
							  [0, [Vector3(95.0, -2.1, -162.5), Vector3(150.0, -2.1, -115.0), Vector3(95.0, -2.1, -195.0)], [Vector3(182.0, -4.0, -125.0), Vector3(200.0, -4.0, -115.0), Vector3(200.0, -4.0, -135.0)], [Vector3(179.29, -1.1, -88.52), Vector3(122.65, -1.1, -98.5), Vector3(69.673, -1.1, -191.89)] ] ]
