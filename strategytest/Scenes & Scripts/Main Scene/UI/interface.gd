...
func updateGamestateInfo():
	var state_text = ""
	state_text += "[b]Ferronit Crystals:[/b] " + str(Global.getResource(Global.player_faction, 0)) + "\n"
	state_text += "[b]Zenezium Crystals:[/b] " + str(Global.getResource(Global.player_faction, 1)) + "\n\n"
