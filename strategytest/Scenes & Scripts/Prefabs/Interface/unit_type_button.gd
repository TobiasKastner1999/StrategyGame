...
func _ready():
	Global.unit_dict["0"]["texture_normal"] = load("res://Assets/UI/OL_Fighter_UI.png")
	Global.unit_dict["0"]["texture_pressed"] = load("res://Assets/UI/OL_Fighter_UI_pressed.png")
	Global.unit_dict["1"]["texture_normal"] = load("res://Assets/UI/OL_GunVehicle_UI.png")
	Global.unit_dict["1"]["texture_pressed"] = load("res://Assets/UI/OL_Fighter_UI_pressed.png")
	Global.unit_dict["2"]["texture_normal"] = load("res://Assets/UI/OL_Fighter_UI.png")
	Global.unit_dict["2"]["texture_pressed"] = load("res://Assets/UI/OL_Fighter_UI_pressed.png")
	Global.unit_dict["3"]["texture_normal"] = load("res://Assets/UI/OL_Fighter_UI.png")
