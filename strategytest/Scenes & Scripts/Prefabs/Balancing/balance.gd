...
@export var faction_zero_resources = [1000,500] # faction 0's balances in the different resources
@export var faction_one_resources = [1000,500] # faction 1's balances in the different resources
