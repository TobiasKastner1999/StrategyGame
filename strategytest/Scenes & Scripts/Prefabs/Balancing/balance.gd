...
@export var faction_zero_resources = [12, 0] # faction 0's balances in the different resources
@export var faction_one_resources = [12, 0] # faction 1's balances in the different resources
